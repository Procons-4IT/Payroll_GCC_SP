...
Public Class FinanceHouseFiles
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll.FinanceHouseFiles.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinanceHouseFiles
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinanceHouseFiles = New FinanceHouseFiles()
        rpt.Site = Me.Site
        Return rpt
    End Function
