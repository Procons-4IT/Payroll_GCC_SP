...
Public Class clsOffToolTransactionImport
    Inherits clsBase
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_TransOffToolImport Then
...
#Region "Read From the XL Files"
    ...
    End Function
#Region "AddtoUDT"
    Private Function AddtoUDT1(ByVal aField1 As String, ByVal aField2 As String, ByVal afield3 As String, ByVal afield4 As String, ByVal afield5 As String, ByVal afield6 As String, ByVal afield7 As String, ByVal afield8 As String, ByVal aPrjCode As String, ByVal aWorkingHours As String, ByVal aIsDedution As String, ByVal aDeductionMonth As String, ByVal aDeductionyear As String) As Boolean
        ...
        For intRow As Integer = 1 To 1
            If aField1 <> "" And (afield3 = "E" Or afield3 = "D") Then
                blnWeekEnd = False
                blnHoliday = False
                ...
                Dim otest As SAPbobsCOM.Recordset
                otest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                otest.DoQuery("Select * from ""@Z_PAY_TRANS"" where ""U_Z_offTool""='Y' and  ""U_Z_EMPID""='" & aField1 & "' and ""U_Z_StartDate""='" & dtDate.ToString("yyyy-MM-dd") & "' and ""U_Z_TYPE""='" & afield3 & "' and ""U_Z_TrnsCode""='" & afield4 & "'")
                ...
                Else
                    ...
                    oUserTable.UserFields.Fields.Item("U_Z_TYPE").Value = afield3
                    oUserTable.UserFields.Fields.Item("U_Z_TrnsCode").Value = afield4
                    oUserTable.UserFields.Fields.Item("U_Z_StartDate").Value = dtDate
                    Dim dblAmount As Double
                    If afield3 <> "E" Then
                        If afield7 <> "" Then
                            dblAmount = getAmount(afield3, aField1, dtDate, oApplication.Utilities.getDocumentQuantity(afield7), afield4)
                        Else
                            dblAmount = oApplication.Utilities.getDocumentQuantity(afield6)
                        End If
                    Else
                        dblAmount = oApplication.Utilities.getDocumentQuantity(afield6)
                        If afield3 = "E" Then
                            If dblAmount = 0 Then
                                dblAmount = getAdvanceSalaryAmount(aField2, afield4, dtDate)
                            End If
                        End If
                    End If
                    oUserTable.UserFields.Fields.Item("U_Z_AMount").Value = dblAmount ' oApplication.Utilities.getDocumentQuantity(afield6)
                    oUserTable.UserFields.Fields.Item("U_Z_NoofHours").Value = oApplication.Utilities.getDocumentQuantity(afield7) ' dblDifference ' orec1.Fields.Item(0).Value
                    If afield8 <> "" Then
                        oUserTable.UserFields.Fields.Item("U_Z_Month").Value = CInt(oApplication.Utilities.getDocumentQuantity(afield8))
                    Else
                        oUserTable.UserFields.Fields.Item("U_Z_Month").Value = dtDate.Month
                    End If
                    If aPrjCode <> "" Then
                        oUserTable.UserFields.Fields.Item("U_Z_year").Value = CInt(oApplication.Utilities.getDocumentQuantity(aPrjCode))
                    Else
                    ...
                    If aIsDedution = "Y" Then
                        oUserTable.UserFields.Fields.Item("U_Z_AffDedu").Value = "Y"
                        oUserTable.UserFields.Fields.Item("U_Z_DedMonth").Value = CInt(oApplication.Utilities.getDocumentQuantity(aDeductionMonth))
                        oUserTable.UserFields.Fields.Item("U_Z_DedYear").Value = CInt(oApplication.Utilities.getDocumentQuantity(aDeductionyear))
                    Else
                        oUserTable.UserFields.Fields.Item("U_Z_AffDedu").Value = "N"
                        oUserTable.UserFields.Fields.Item("U_Z_DedMonth").Value = 0
                        oUserTable.UserFields.Fields.Item("U_Z_DedYear").Value = 0
                    End If
                ...
                If i > 0 And fieldData.Length > 6 Then
                    ...
                    If strField1 <> "" Or strField2 <> "" Then
                        ...
                        If 1 = 1 Then 'intNo > 0 Then
                            AddtoUDT1(strField1, strField2, strField3, strField4, strField5, strField6, strField7, strField8, strField9, strWorkingHours, strisDedution, strDeductionMonth, strDeductionyear)
                        End If
                    End If
                End If
            Next lineOfText
        ...
        Try
            Select Case pVal.MenuUID
                Case mnu_TransOffToolImport
                    objForm = oApplication.Utilities.LoadForm(xml_TransOffToolImport, frm_TransOffToolImport)
