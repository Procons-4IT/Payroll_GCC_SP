...
#Region "Databind"
    Private Sub Databind(ByVal aform As SAPbouiCOM.Form, ByVal aChoice As String)
        Try
            ...
            strsql = strsql & " T0.[U_Z_WorkDay] 'DayType', T0.[U_Z_OvtType] 'OverTimeType',  T0.[U_Z_OvtName] 'OverTimeName', T0.[U_Z_OverTime] 'OverTime',  T0.[U_Z_LeaveType] 'AbsenseType',T0.[U_Z_PrjCode] 'Project Code',"
