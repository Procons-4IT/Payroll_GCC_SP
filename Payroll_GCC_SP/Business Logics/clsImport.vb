...
#Region "AddtoUDT"
    Private Function AddtoUDT1(ByVal aField1 As String, ByVal aField2 As String, ByVal afield3 As String, ByVal afield4 As String, ByVal afield5 As String, ByVal afield6 As String, ByVal afield7 As String, ByVal aLeaveType As String, ByVal aPrjCode As String, ByVal aWorkingHours As String) As Boolean
        ...
        For intRow As Integer = 1 To 1
            If aField1 <> "" Then
                ...
                dbltotalworkedhours = oApplication.Utilities.getDocumentQuantity(aWorkingHours)
                ...
                Else
                    ...
                    strHoursworked = dbltotalworkedhours.ToString("00:00:00")
                    strActualworkinghours = strHoursworked
                    ' oUserTable.UserFields.Fields.Item("U_Z_Hours").Value = orec1.Fields.Item(0).Value
                End If

                If afield6 = "" And afield7 = "" Then
                    strActualworkinghours = "00:00:00"
                    strHoursworked = dbltotalworkedhours '.ToString("00:00:00")
                    '   Dim dt As DateTime = Convert.ToDateTime(dblworkinghours)
                    strActualworkinghours = strHoursworked
                End If
                ...
                If strCode = "" Then
                    ...
                    '    orec1.DoQuery("select empid,isnull(U_Z_EmpID,''),T0.U_Z_ShiftCode,U_Z_ShiftName,U_Z_Total,isnull(U_Z_HldCode,'') 'Holiday'  from [OHEM] T0 inner  join [@Z_LEB_WORKSC] T1 on T0.U_Z_ShiftCode=T1.U_Z_ShiftCode where isnull(U_Z_empID,'')='" & aField1 & "'")
                    'orec1.DoQuery("select * ,empid,isnull(U_Z_EmpID,''),T0.U_Z_ShiftCode,U_Z_ShiftName,U_Z_Total,isnull(U_Z_HldCode,'') 'Holiday', isnull(U_Z_BTotal,0) 'Break' from [OHEM] T0 inner  join [@Z_LEB_WORKSC] T1 on T0.U_Z_ShiftCode=T1.U_Z_ShiftCode where T1.U_Z_ShiftCode='" & strShiftID & "' and  isnull(U_Z_empID,'')='" & aField1 & "'")
                    ...
                    Dim dblHolidayWorkingHours As Double
                    If orec1.RecordCount > 0 Then
                        ...
                        dblHolidayWorkingHours = dblworkinghours
                    ...
                    If afield6 = "" And afield7 = "" Then
                        dblactual = oApplication.Utilities.getDocumentQuantity(aWorkingHours)
                    Else
                    ...
                    '    dblactual = oApplication.Utilities.getDocumentQuantity(aWorkingHours)
                    'End If
                    Dim dblActualWOrkingHours As Double
                    ...
                    If dblOverTime > 0 Then
                        dblActualWOrkingHours = dblactual - dblOverTime
                    Else
                        dblOverTime = 0
                        dblActualWOrkingHours = dblactual
                    End If
                    ' dblActualWOrkingHours = dblactual - dblOverTime
                    If blnWeekEnd = True Then
                        dblActualWOrkingHours = 0
                    End If
                    If blnHoliday = True Then
                        dblActualWOrkingHours = dblHolidayWorkingHours
                    End If

                    oUserTable.UserFields.Fields.Item("U_Z_ActHours").Value = dblActualWOrkingHours
                    If dblactual > 0 Then
                ...
                Else
                    ...
                    If oUserTable.GetByKey(strCode) Then
                        ...
                        dblworkinghours = dblworkinghours - dblBreakHours
                        Dim strwork As String
                        Dim dblactual, dblActualWOrkingHours As Double
                        If afield6 = "" And afield7 = "" Then
                            dblactual = oApplication.Utilities.getDocumentQuantity(aWorkingHours)
                        Else
                            strwork = strActualworkinghours.Substring(0, 5)
    ...
    Public Overrides Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        Try
            Select Case pVal.MenuUID
                Case mnu_Import
                    objForm = oApplication.Utilities.LoadForm(xml_Import, frm_Import)
