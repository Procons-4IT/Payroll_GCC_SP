...
Public Class clsTransactionImport
    Inherits clsBase
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_TransImport Then
...
#Region "Read From the XL Files"
    ...
    End Function
#Region "AddtoUDT"
    Private Function AddtoUDT1(ByVal aField1 As String, ByVal aField2 As String, ByVal afield3 As String, ByVal afield4 As String, ByVal afield5 As String, ByVal afield6 As String, ByVal afield7 As String, ByVal afield8 As String, ByVal aPrjCode As String, ByVal aWorkingHours As String) As Boolean
        ...
        For intRow As Integer = 1 To 1
            If aField1 <> "" Then
                ...
                Dim otest As SAPbobsCOM.Recordset
                otest = oApplication.Company.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                otest.DoQuery("Select * from ""@Z_PAY_TRANS"" where ""U_Z_EMPID""='" & aField1 & "' and ""U_Z_StartDate""='" & dtDate.ToString("yyyy-MM-dd") & "' and ""U_Z_TYPE""='" & afield3 & "' and ""U_Z_TrnsCode""='" & afield4 & "'")
        ...
        Try
            Select Case pVal.MenuUID
                Case mnu_TransImport
                    objForm = oApplication.Utilities.LoadForm(xml_TransImport, frm_TransImport)
