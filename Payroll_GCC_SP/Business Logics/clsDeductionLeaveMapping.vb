Public Class clsDeductionLeaveMapping
    Inherits clsBase
    ...
    Public Sub LoadForm(ByVal aCode As String, ByVal aName As String)
        If oApplication.Utilities.validateAuthorization(oApplication.Company.UserSignature, frm_Deduction_LeaveMapping) = False Then
            oApplication.Utilities.Message("You are not authorized to do this action", SAPbouiCOM.BoStatusBarMessageType.smt_Error)
            Exit Sub
        End If

        oForm = oApplication.Utilities.LoadForm(xml_Deduction_LeaveMapping, frm_Deduction_LeaveMapping)
...
#Region "Databind"
    Public Sub Databind(ByVal aform As SAPbouiCOM.Form)
        Try
            ...
            dtTemp.ExecuteQuery("SELECT T0.[Code], T0.[Name], T0.[U_Z_LEVCODE],T0.[U_Z_EFFPAY] FROM [dbo].[@Z_PAY_OLEMAP]  T0 where Isnull(U_Z_Type,'E')='D' and  U_Z_CODE='" & oApplication.Utilities.getEdittextvalue(aform, "5") & "' order by Code")
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If oComboColumn.GetSelectedValue(intRow).Value <> "" Then
                ...
                If oUserTable.GetByKey(strCode) Then
                    ...
                    oUserTable.UserFields.Fields.Item("U_Z_Type").Value = "D"
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_Deduction_LeaveMapping Then
